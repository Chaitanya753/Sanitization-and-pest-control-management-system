...
// Fetch all payment records (Admin View)
$query = "SELECT b.booking_id AS booking_id, b.customer_name, b.service_type, b.service_time, 
                 p.payment_id AS payment_id, p.price, p.payment_status
          FROM bookings b
